...
$(BUILD)/bin/libhttp.dylib: $(DEPS_53)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/libappweb.dylib: $(DEPS_54)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libappweb.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libappweb.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" "$(BUILD)/obj/dirHandler.o" "$(BUILD)/obj/fileHandler.o" "$(BUILD)/obj/log.o" "$(BUILD)/obj/server.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) -lpam 
...
ifeq ($(ME_COM_SQLITE),1)
    DEPS_61 += $(BUILD)/bin/libsql.dylib
endif
...
$(BUILD)/bin/libejs.dylib: $(DEPS_61)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/ejsLib.o" $(LIBPATHS_61) $(LIBS_61) $(LIBS_61) $(LIBS) -lpam 
endif
...
ifeq ($(ME_COM_SQLITE),1)
    DEPS_62 += $(BUILD)/bin/libsql.dylib
endif
...
$(BUILD)/bin/libmod_esp.dylib: $(DEPS_67)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_esp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_esp.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/espLib.o" $(LIBPATHS_67) $(LIBS_67) $(LIBS_67) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/libmod_cgi.dylib: $(DEPS_73)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_cgi.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_cgi.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/cgiHandler.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/libmod_ejs.dylib: $(DEPS_74)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_ejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_ejs.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/ejsHandler.o" $(LIBPATHS_74) $(LIBS_74) $(LIBS_74) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/libmod_php.dylib: $(DEPS_75)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_php.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_php.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/phpHandler.o" $(LIBPATHS_75) $(LIBS_75) $(LIBS_75) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/libmprssl.dylib: $(DEPS_76)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmprssl.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/mprSsl.o" $(LIBPATHS_76) $(LIBS_76) $(LIBS_76) $(LIBS) 
...
$(BUILD)/bin/libmod_ssl.dylib: $(DEPS_77)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_ssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmod_ssl.dylib -compatibility_version 4.7 -current_version 4.7 "$(BUILD)/obj/sslModule.o" $(LIBPATHS_77) $(LIBS_77) $(LIBS_77) $(LIBS) -lpam 
endif
